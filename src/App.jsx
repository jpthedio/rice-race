...
function Footer(){return(<footer style={{background:"#0A0D0A",borderTop:"1px solid rgba(255,255,255,0.05)",padding:"1.5rem 2.5rem",display:"flex",justifyContent:"space-between",alignItems:"center",gap:"1rem",flexWrap:"wrap"}}><p className="rr-mono" style={{fontSize:"0.8rem",color:"var(--muted)"}}>Rice Race / Uplifting Filipinos Through AI</p><p className="rr-mono" style={{fontSize:"0.75rem",color:"var(--goldd)"}}>Anthropic / OpenAI / WEF / Ramp / TransUnion PH / PSA / Po-Shen Loh / Sam Altman</p></footer>);}
